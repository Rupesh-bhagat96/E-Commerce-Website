...
const Navbar = () => {
    ...
    const {setShowSearch} = useContext(ShopContex)
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
        ...
        <div className='flex gap-6 items-center'>
            <Link to={'collection'}> <img onClick={()=>setShowSearch(prev=>!prev)} src={assets.search_icon} className='w-5 cursor-pointer' alt="" /></Link>
            ...
            <div className={`absolute top-0 bottom-0 right-0 overflow-hidden bg-white transition-all ${visible? 'w-full':'w-0'}`}>
               <div className='flex flex-col text-gray-600'>
                 <div onClick={()=>setVisible(false)} className='border flex items-center gap-4 p-3'>
